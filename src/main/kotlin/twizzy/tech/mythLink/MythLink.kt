...
@Plugin(
    id = "mythlink", name = "MythLink", authors = ["mightbmax"], version = BuildConstants.VERSION
)
class MythLink @Inject constructor(
    ...
    fun onProxyShutdown(event: ProxyShutdownEvent) {
        logger.info(Component.text("MythLink is shutting down..."))
